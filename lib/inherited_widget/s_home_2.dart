...
class HomeScreen2 extends StatefulWidget {
  ...
  @override
  State<HomeScreen2> createState() => _HomeScreen1State();
}

class _HomeScreen1State extends State<HomeScreen2> {
  // 현재 선택된 index
  int currentIndex = 0;
    ...
    try {
      setState(() {
        ...
        if(catalogList.contains(catalog)) {
          // 삭제를 해야한다. --> cartList객체를 새로 생성해서 처리해야
          // 깊은 복사 개념으로 동작한다.
          // [1,2,3,4] -> 4만 삭제
          // catalogList 변수에 새로운 List객체를 생성해서 기존에 있던 데이터
          // [1,2,3] 을 넣는 것이 목표다.
